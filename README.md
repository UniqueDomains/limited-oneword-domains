...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C325%20rows-8250df">
...
- `limited.csv` — public CSV extract (9,325 rows)
- `limited.json` — public JSON extract (9,325 rows)
...
| craft.limited    | available | $14.99    | $52.99        | 70             | 41     | 5      | name.com                                                  |
...
| ----------------------- | ------------------------------------------------ |
| 9,325-row public sample | 9,325 live domains                               |
